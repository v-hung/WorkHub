...
export class TimesheetApiRequestFactory extends BaseAPIRequestFactory {
    ...
    /**
     */
    public async timesheetTest(_options?: Configuration): Promise<RequestContext> {
...
export class TimesheetApiResponseProcessor {
     ...
     *
     * @params response Response returned by the server for a request to timesheetTest
     * @throws ApiException if the response code was not in [200, 299]
     */
     public async timesheetTestWithHttpInfo(response: ResponseContext): Promise<HttpInfo<string >> {
