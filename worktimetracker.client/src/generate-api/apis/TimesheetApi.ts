...
export class TimesheetApiResponseProcessor {
     ...
     */
     public async timesheetCheckInWithHttpInfo(response: ResponseContext): Promise<HttpInfo<TimesheetDto >> {
     ...
     * @throws ApiException if the response code was not in [200, 299]
     */
     public async timesheetCheckOutWithHttpInfo(response: ResponseContext): Promise<HttpInfo<TimesheetDto >> {
        const contentType = ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
        if (isCodeInRange("200", response.httpStatusCode)) {
            const body: TimesheetDto = ObjectSerializer.deserialize(
                ObjectSerializer.parse(await response.body.text(), contentType),
     ...
     * @throws ApiException if the response code was not in [200, 299]
     */
     public async timesheetGetTodayTimesheetWithHttpInfo(response: ResponseContext): Promise<HttpInfo<TimesheetDto >> {
        const contentType = ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
        if (isCodeInRange("200", response.httpStatusCode)) {
            const body: TimesheetDto = ObjectSerializer.deserialize(
                ObjectSerializer.parse(await response.body.text(), contentType),
