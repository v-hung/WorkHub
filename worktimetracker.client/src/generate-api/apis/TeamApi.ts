...
export class TeamApiRequestFactory extends BaseAPIRequestFactory {
     ...
     * @param ids 
     */
    public async teamGetAll(ids?: Array<number>, _options?: Configuration): Promise<RequestContext> {
        let _config = _options || this.configuration;
     ...
     */
    public async teamSearch(pageNumber: number, pageSize: number, searchString?: string, orderBy?: Array<string>, _options?: Configuration): Promise<RequestContext> {
        let _config = _options || this.configuration;

        // verify required parameter 'pageNumber' is not null or undefined
        if (pageNumber === null || pageNumber === undefined) {
            throw new RequiredError("TeamApi", "teamSearch", "pageNumber");
        }


        // verify required parameter 'pageSize' is not null or undefined
        if (pageSize === null || pageSize === undefined) {
            throw new RequiredError("TeamApi", "teamSearch", "pageSize");
        }
...
export class TeamApiResponseProcessor {
     ...
     * @throws ApiException if the response code was not in [200, 299]
     */
     public async teamGetAllWithHttpInfo(response: ResponseContext): Promise<HttpInfo<Array<TeamDto> >> {
        const contentType = ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
        if (isCodeInRange("200", response.httpStatusCode)) {
     ...
     * to the expected objects
     *
     * @params response Response returned by the server for a request to teamSearch
     * @throws ApiException if the response code was not in [200, 299]
     */
     public async teamSearchWithHttpInfo(response: ResponseContext): Promise<HttpInfo<TeamDtoPaginated >> {
        const contentType = ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
        if (isCodeInRange("200", response.httpStatusCode)) {
