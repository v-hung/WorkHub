...
export class UserApiResponseProcessor {
   ...
   */
  public async userCreateWithHttpInfo(
    ...
    if (isCodeInRange("400", response.httpStatusCode)) {
      ...
      throw new ApiException<ErrorValidateResponse>(
        response.httpStatusCode,
        "",
        body,
        response.headers
   ...
   * @throws ApiException if the response code was not in [200, 299]
   */
  public async userDeleteWithHttpInfo(
    response: ResponseContext
   ...
   * @throws ApiException if the response code was not in [200, 299]
   */
  public async userGetAllWithHttpInfo(
    response: ResponseContext
   ...
   * @throws ApiException if the response code was not in [200, 299]
   */
  public async userGetByIdWithHttpInfo(
    response: ResponseContext
   ...
   * @throws ApiException if the response code was not in [200, 299]
   */
  public async userUpdateWithHttpInfo(
    response: ResponseContext
  ): Promise<HttpInfo<UserDto>> {
    const contentType = ObjectSerializer.normalizeMediaType(
      response.headers["content-type"]
