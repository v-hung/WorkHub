...
export interface RoleApiRoleGetByNameRequest {
    /**
     * 
     * Defaults to: undefined
     * @type string
     * @memberof RoleApiroleGetByName
     */
    name: string
}
...
export class ObjectRoleApi {
     ...
     * @param param the request object
     */
    public roleGetByNameWithHttpInfo(param: RoleApiRoleGetByNameRequest, options?: ConfigurationOptions): Promise<HttpInfo<RoleDto>> {
        return this.api.roleGetByNameWithHttpInfo(param.name,  options).toPromise();
    }

    /**
     * @param param the request object
     */
    public roleGetByName(param: RoleApiRoleGetByNameRequest, options?: ConfigurationOptions): Promise<RoleDto> {
        return this.api.roleGetByName(param.name,  options).toPromise();
    }
