...
export class PromiseRequestsApi {
    ...
    public leaveRequestApprovalRequestWithHttpInfo(id: number, _options?: PromiseConfigurationOptions): Promise<HttpInfo<RequestCombinedDto>> {
        ...
        const result = this.api.leaveRequestApprovalRequestWithHttpInfo(id, observableOptions);
        return result.toPromise();
    }
    ...
    public leaveRequestApprovalRequest(id: number, _options?: PromiseConfigurationOptions): Promise<RequestCombinedDto> {
        ...
        const result = this.api.leaveRequestApprovalRequest(id, observableOptions);
        return result.toPromise();
    }
    ...
    public leaveRequestCancelRequestWithHttpInfo(id: number, _options?: PromiseConfigurationOptions): Promise<HttpInfo<RequestCombinedDto>> {
        ...
        const result = this.api.leaveRequestCancelRequestWithHttpInfo(id, observableOptions);
        return result.toPromise();
    }
    ...
    public leaveRequestCancelRequest(id: number, _options?: PromiseConfigurationOptions): Promise<RequestCombinedDto> {
        ...
        const result = this.api.leaveRequestCancelRequest(id, observableOptions);
        return result.toPromise();
    }
    ...
    public leaveRequestCreateRequestWithHttpInfo(createLeaveRequestDto?: CreateLeaveRequestDto, _options?: PromiseConfigurationOptions): Promise<HttpInfo<RequestCombinedDto>> {
        ...
        const result = this.api.leaveRequestCreateRequestWithHttpInfo(createLeaveRequestDto, observableOptions);
        return result.toPromise();
    }
    ...
    public leaveRequestCreateRequest(createLeaveRequestDto?: CreateLeaveRequestDto, _options?: PromiseConfigurationOptions): Promise<RequestCombinedDto> {
        ...
        const result = this.api.leaveRequestCreateRequest(createLeaveRequestDto, observableOptions);
        return result.toPromise();
    }
    ...
    public leaveRequestRejectRequestWithHttpInfo(id: number, _options?: PromiseConfigurationOptions): Promise<HttpInfo<RequestCombinedDto>> {
        ...
        const result = this.api.leaveRequestRejectRequestWithHttpInfo(id, observableOptions);
        return result.toPromise();
    }
    ...
    public leaveRequestRejectRequest(id: number, _options?: PromiseConfigurationOptions): Promise<RequestCombinedDto> {
        ...
        const result = this.api.leaveRequestRejectRequest(id, observableOptions);
        return result.toPromise();
    }
...
export class PromiseRoleApi {
     ...
     * @param name
     */
    public roleGetByNameWithHttpInfo(name: string, _options?: PromiseConfigurationOptions): Promise<HttpInfo<RoleDto>> {
        let observableOptions: undefined | ConfigurationOptions
        if (_options){
	    observableOptions = {
                baseServer: _options.baseServer,
        ...
        const result = this.api.roleGetByNameWithHttpInfo(name, observableOptions);
        return result.toPromise();
    }
     ...
     * @param name
     */
    public roleGetByName(name: string, _options?: PromiseConfigurationOptions): Promise<RoleDto> {
        let observableOptions: undefined | ConfigurationOptions
        if (_options){
	    observableOptions = {
                baseServer: _options.baseServer,
        ...
        const result = this.api.roleGetByName(name, observableOptions);
        return result.toPromise();
    }
