...
export class AccountApi extends runtime.BaseAPI {
  /**
   */
  async accountChangePasswordRaw(
    requestParameters: AccountChangePasswordRequest,
  ...
  /**
   */
  async accountGetCurrentUserRaw(
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ...
  /**
   */
  async accountGetPermissionsRaw(
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ...
  /**
   */
  async accountLoginRaw(
    requestParameters: AccountLoginRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<runtime.ApiResponse<UserDtoLoginResponse>> {
    const queryParameters: any = {};
    ...
    return new runtime.JSONApiResponse(response, (jsonValue) =>
      UserDtoLoginResponseFromJSON(jsonValue)
    );
  }
  ...
  async accountLogin(
    ...
    const response = await this.accountLoginRaw(
      requestParameters,
      initOverrides
    );
    return await response.value();
